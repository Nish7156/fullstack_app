...
function Header() {
  return (
   ...
   <div className="z-50 flex items-center justify-between w-full px-4 py-5 transition-transform duration-300 bg-white border-b shadow-sm  h-14 transform-gpu border-border-200 bg-light md:h-16 lg:h-22 lg:px-8">
