      ...
      <header className="site-header-with-search h-14 md:h-16 lg:h-22 lg:!h-auto">
        <div className="fixed z-50 flex items-center justify-between w-full px-4 py-5 transition-transform duration-300 bg-white border-b shadow-sm h-14 transform-gpu border-border-200 bg-light md:h-16 lg:h-22 lg:px-8">
          <div className="flex items-center w-full lg:w-auto">
            {/* img */}
            <a className="inline-flex mx-auto lg:mx-0" href="/">
              <span className="relative w-32 h-10 overflow-hidden md:w-40">
                <span className="box-sizing:border-box;display:block;overflow:hidden;width:initial;height:initial;background:none;opacity:1;border:0;margin:0;padding:0;position:absolute;top:0;left:0;bottom:0;right:0">
                  <img
                    ...
                    decoding="async"
                    data-nimg="fill"
                    className="position:absolute;top:0;left:0;bottom:0;right:0;box-sizing:border-box;padding:0;border:none;margin:auto;display:block;width:0;height:0;min-width:100%;max-width:100%;min-height:100%;max-height:100%;object-fit:contain"
                  />
                </span>
              </span>
            </a>
            <div className="hidden ltr:ml-10 ltr:mr-auto rtl:mr-10 rtl:ml-auto xl:block">
              <div className="relative inline-block ltr:text-left rtl:text-right">
                <button
                  className="flex items-center text-sm font-semibold rounded h-11 shrink-0 text-heading focus:outline-none md:text-base xl:px-4 border-border-200 bg-light xl:min-w-150 xl:border xl:text-accent"
          ...
          <ul className="items-center hidden shrink-0 space-x-7 rtl:space-x-reverse lg:flex 2xl:space-x-10">
            ...
            <div className="flex items-center space-x-4 rtl:space-x-reverse">
              <a
                href="https://pickbazar-react-admin.vercel.app/register"
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center px-3 py-0 text-sm font-semibold leading-none text-white transition duration-300 ease-in-out bg-green-500 border border-transparent rounded outline-none h-9 shrink-0 bg-accent text-light hover:bg-accent-hover focus:shadow focus:outline-none focus:ring-1 focus:ring-accent-700"
              >
                Become a Seller
              </a>
              <li>
