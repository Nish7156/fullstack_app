...
const Category = ({text}) => {
  return (
    ...
    >
      <button className="flex items-center w-full py-2 text-sm font-semibold transition-all outline-none ju text-body-dark ease-in-expo focus:text-accent focus:outline-none focus:ring-0 ">
...
function SideFilter() {
  return (
    <div className="fixed h-full lg:sticky">
        ...
        <div className="flex-grow max-h-full overflow-hidden">
          <div className="px-5">
            <ul className="text-xs xl:py-8">
              ...
              <Category text="Fruits & Vegetables" />
              <Category text="Health & Beauty" />
              <Category text="Dairy" />
            </ul>
          </div>
        </div>
