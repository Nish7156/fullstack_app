...
const P=()=>{
    return(
        ...
        <header className="p-3 md:p-6">
          ...
          <h3 className="mb-4 text-xs truncate cursor-pointer text-body md:text-sm">
            Apples
          </h3>
          <button className="flex items-center justify-between w-full text-xs transition-colors bg-gray-100 rounded group h-7 text-body-dark hover:border-accent hover:bg-accent hover:text-light focus:border-accent focus:bg-accent focus:text-light focus:outline-none md:h-9 md:text-sm">
            <span className="flex-1">Add</span>
            <span className="grid transition-colors duration-200 bg-gray-200 h-7 w-7 place-items-center group-hover:bg-accent-600 group-focus:bg-accent-600 ltr:rounded-tr ltr:rounded-br rtl:rounded-tl rtl:rounded-bl md:h-9 md:w-9">
              <svg
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
