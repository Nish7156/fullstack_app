...
function Footer() {
  ...
  <nav className="fixed bottom-0 bg-white z-10 flex h-12 w-full justify-between bg-light py-1.5 px-2 shadow-400 ltr:left-0 rtl:right-0 md:h-14">
    <button className="flex items-center justify-center h-full p-2 focus:text-accent focus:outline-none">
    ...
    <button className="relative flex items-center justify-center h-full p-2 product-cart focus:text-accent focus:outline-none">
      ...
      <span className="absolute top-0 mt-0.5 rounded-full bg-accent py-1 px-1.5 text-10px font-semibold leading-none text-light ltr:right-0 ltr:-mr-0.5 rtl:left-0 rtl:-ml-0.5">4</span>
    </button>
    <button className="flex items-center justify-center h-full p-2 focus:text-accent focus:outline-none">
